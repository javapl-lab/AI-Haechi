...
from cfg_class.CFG import CFG
from cfg_class.Node import Node
from cfg_class.GlobalCounter import GlobalCounter
from SolidityToAST import solidityToAst
...
def ConditionalStatementProcessing(node, cfg=None):
    # Block 하위 리스트 순회
...
def execute(filename):
    ast = parser.parse(solidityToAst(filename), loc=False)
    cfg_list = []
